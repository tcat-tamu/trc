...
public interface EntryResolverRegistry
{
    ...
    */
   String tokenize(EntryReference ref);

   /**
    * @param token A token to decode as generated by {@link #tokenize(EntryReference)}
    ...
    */
   EntryReference decodeToken(String token) throws IllegalArgumentException, InvalidReferenceException;
