package edu.tamu.tcat.trc.notes.impl;
...
import edu.tamu.tcat.trc.notes.impl.model.NoteImpl;
import edu.tamu.tcat.trc.notes.impl.repo.DataModelV1;
import edu.tamu.tcat.trc.notes.impl.repo.EditNoteCommandFactory;
...
//            searchReg.close();
   ...
   public class NotesRepoImpl implements NotesRepository
   {
      ...
      private PsqlJacksonRepo<Note, edu.tamu.tcat.trc.notes.impl.repo.DataModelV1.Note, EditNoteCommand> docRepo;
